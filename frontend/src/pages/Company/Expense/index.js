...
import { DeleteExpense, EditExpense, RegisterExpense } from '../../../components/Expense';
...
function Expense() {
  ...
  return (
    <div id="page-dashboard">
                    ...
                    <tr key={dice._id}>
                      ...
                      <td>
                        <div className="table-button">
                          ...
                          <button onClick={() => DeleteExpense(dice._id, array, setArray)} className="button is-danger is-medium">Excluir</button>
                        </div>
                      </td>
                    </tr>
                  )
      ...
      <RegisterExpense active={modal} close={closeModal} />
      <EditExpense active={editModal} close={closeEditModal} />
